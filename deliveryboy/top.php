<?php
   ...
   $dbid = $_SESSION['IS_DELIVERY_USER'];
   $deleveyboydata = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM delivery_boy WHERE id='$dbid'"));
?>
<!DOCTYPE html>
<html lang="en">
   <head>
   ...
   <body class="sidebar-light">
         ...
         <div class="navbar-menu-wrapper d-flex align-items-stretch justify-content-between">
            ...
            <ul class="navbar-nav navbar-nav-right">
               <li class="nav-item nav-profile dropdown">
                  ...
                  <span class="nav-profile-name"><?php echo $deleveyboydata['name']; ?></span>
                  </a>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
         <ul class="nav">
            ...
            <li class="nav-item">
               <a class="nav-link" href="alldeleverd">
