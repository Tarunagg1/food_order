                    ...
                    <div class="col-lg-9">
                        <div class="banner-area pb-30">
                            <div class="typecon">
                                ...
                                ?>
                                    <span class="dishtypespan"><?php echo $list; ?>:</span> <input class="radiodishtype" type="radio" <?php echo $isselected; ?> value="<?php echo $list; ?>"  onclick="setfood('<?php echo $list; ?>')" name="type">
                                <?php } ?>
                            </div>
                        </div>
                        <div class="banner-area pb-30">
